...
public record RecordConstructorCompactParameterAnnotatedTypeUse(@AnnotationWithExperimentalTypeUse int i) {

    public RecordConstructorCompactParameterAnnotatedTypeUse {
    }
}
